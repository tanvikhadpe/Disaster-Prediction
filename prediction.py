...
weather_data = []
weather_labels = []
db = pymysql.connect(host="localhost",user="root",passwd="Tanvi@123",db="dmnat")
...
def covid_tom():
    ...
    sn_plot3.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/covid/output3.png')
    ...
    sn_plot.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/covid/output1.png')
    print("predicted_graph")
    sn_plot1=sns.relplot(data=future_df[:73])
    sn_plot1.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/covid/output2.png')
...
def covid19():
    ...
    key = '3ad684727aa545279bc0004c3bc93294'
            ...
            if var[0]>6:
               ...
               # smtp_server.ehlo()
                ...
                with smtplib.SMTP_SSL(smtp_server, port, context=context) as server:
                    ...
                    server.sendmail(sender_email, receiver_email, message)
                import nexmo
                client = nexmo.Client(key='0b740b21', secret='K86op8aBr4K8knUF')
                client.send_message({
                    'from': 'Natural Disaster',
                    'to': '', # your phone number
                    'text': 'Hello from Nexmo | Vonage, Tanvi',
                    })
                from twilio.rest import Client

                account_sid = 'ACe83e97176ba903840c4deaab893483de'
                auth_token = '170fd236eacd1e6fe77f7e6cd01bdd61'
                client = Client(account_sid, auth_token)

                message = client.messages.create(
                from_='whatsapp:+14155238886',
                body='Earthquake Alert! There is a possibility of an earthquake in your region. This is a warning message from Tanvi Khadpe.',
...
def predhurricane():
    ...
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/hurricane/hurrd1.png')
    plt.scatter(x_test['Date'], y_test)
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/static/hurricane/hurrd2.png')
    plt.scatter(x_test['Date'], results)
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/static/hurricane/hurrd.png')
...
def predflood():
    ...
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/flood/f1.png')
    ...
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/flood/f2.png') 
    ...
    plt.xlabel('Rainfall')  
    plt.ylabel('Max Level')  
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/flood/f3.png') 
    ...
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/flood/f4.png')
    plt.scatter(X_test, y_test, color = 'red')
    plt.plot(X_train, regressor.predict(X_train), color = 'blue')
    plt.title('Rainfall Vs River Level (Training set)')
    plt.xlabel('Rainfall')
    plt.ylabel('River Level')
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/flood/f5.png')
...
def comprede():
    ...
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/graphs/em1.png')
    ...
    plt.savefig('C:/Users/Tanvi/Downloads/capstone/capstone/static/graphs/em2.png')
